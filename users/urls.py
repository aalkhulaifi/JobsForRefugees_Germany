...
urlpatterns = [
    ...
    path('tasker_notifications/<int:request_id>/', views.tasker_notifications, name = 'tasker_notifications' ),
    path('user_notification/', views.user_notification, name = 'user_notification' ),
    path('user_notifications/<int:request_id>/', views.user_notifications, name = 'user_notifications' ),
